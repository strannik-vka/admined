  ...
  constructor(props) {
    ...
    */
    ...
    if (isObject(this.props.editItem)) {
      fields = isObject(this.props.editItem) ? getDataValue(this.props.input.name, this.props.editItem) : [];
  ...
  render() {
    ...
    return this.state.fields.map((item, index) => {
      ...
      return /*#__PURE__*/React.createElement("fieldset", {
        ...
        className: "multiple_block_placeholder"
      }, this.props.input.placeholder + ' ' + (index + 1)), /*#__PURE__*/React.createElement("div", {
