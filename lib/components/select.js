...
class Select extends React.Component {
  ...
  render() {
    ...
    options.map(option => {
      option.value = typeof option === 'string' ? option : typeof option.id !== 'undefined' ? option.id : typeof option.value !== 'undefined' ? option.value : '';
      option.label = typeof option === 'string' ? option : typeof this.props.text_key !== 'undefined' ? option[this.props.text_key] : option.name;
