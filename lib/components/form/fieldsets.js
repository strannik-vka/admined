...
class Fildsets extends React.Component {
  constructor(props) {
    ...
    */
    ...
    var fields = typeof this.props.editItem[this.props.input.name] === 'object' && this.props.editItem[this.props.input.name] != null ? this.props.editItem[this.props.input.name] : [];
  ...
  render() {
    ...
    return this.state.fields.map((item, index) => {
      ...
      return /*#__PURE__*/React.createElement("fieldset", {
        key: item.id,
        className: fieldsCount - 1 == index ? 'form-group' : 'form-group mb-3'
      }, /*#__PURE__*/React.createElement("legend", null, this.props.input.placeholder + ' ' + (index + 1), /*#__PURE__*/React.createElement("div", {
        onClick: () => this.fieldsAdd(),
        ...
        onClick: () => this.fieldsTrash(item.id),
        className: "multiple_block_icon"
      }, /*#__PURE__*/React.createElement("svg", {
        className: "delete",
        viewBox: "0 0 14 14"
