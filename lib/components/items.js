...
class Items extends React.Component {
  ...
  isEditEnabled() {
    ...
    if (typeof this.props.page.editAction !== 'undefined') {
      if (this.props.page.editAction == false) {
        result = false;
      }
    }
  ...
  string(item, input) {
    return /*#__PURE__*/React.createElement(DivInput, {
      ...
      center: input.center,
      value: item[input.name],
      with: item[input.name.replace('_id', '')],
      text_key: input.text_key,
  ...
  render() {
    ...
    }), this.isEditEnabled() ? /*#__PURE__*/React.createElement(OverlayTrigger, {
      key: "top",
      placement: "top",
