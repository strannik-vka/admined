...
class DivInput extends React.Component {
  ...
  getValue() {
    ...
    if (isObject(this.props.with) && typeof this.props.text_key !== 'undefined') {
      value = typeof this.props.with[this.props.text_key] !== 'undefined' ? this.props.with[this.props.text_key] : '';
    }
  ...
  onClick() {
    ...
    if (isHref) {
      window.open(template(this.props.href, this.props.item), typeof this.props.target !== 'undefined' && this.props.target ? this.props.target : '');
    }
  }
