...
class Constructor extends React.Component {
  ...
  onMouseEnter = field => {
    this.setState({
      screen: this.props.screen && this.props.screen[field.type] ? this.props.screen[field.type] : null
    });
  };
  onMouseLeave = () => {
    this.setState({
  ...
  getActions(id, index) {
    ...
    if (isEnd) {
      buttons.push( /*#__PURE__*/React.createElement("div", {
        key: 'btn_' + id + '_' + index + '_empty',
        className: "desc"
      }, "\u041D\u0430\u0436\u043C\u0438 \u043D\u0430 \u043F\u043B\u044E\u0441\u0438\u043A, \u0447\u0442\u043E\u0431\u044B \u0434\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u043D\u0435\u043E\u0431\u0445\u043E\u0434\u0438\u043C\u044B\u0439 \u043A\u043E\u043D\u0442\u0435\u043D\u0442"));
    } else {
      buttons.push( /*#__PURE__*/React.createElement("div", {
        key: 'btn_' + id + '_' + index + '_add',
        className: "multiple_block_icon",
        onClick: () => this.delField(id)
      ...
      if (!isFirst) {
        buttons.push( /*#__PURE__*/React.createElement("div", {
          key: 'btn_' + id + '_' + index + '_up',
          className: "multiple_block_icon",
          onClick: () => this.dragField(id, true)
        }, /*#__PURE__*/React.createElement("svg", {
          width: "16",
          height: "16",
          viewBox: "0 0 16 16",
          ...
          d: "M8.53033 1.36967C8.23744 1.07678 7.76256 1.07678 7.46967 1.36967L2.6967 6.14264C2.40381 6.43554 2.40381 6.91041 2.6967 7.2033C2.98959 7.4962 3.46447 7.4962 3.75736 7.2033L8 2.96066L12.2426 7.2033C12.5355 7.4962 13.0104 7.4962 13.3033 7.2033C13.5962 6.91041 13.5962 6.43554 13.3033 6.14264L8.53033 1.36967ZM8.75 14.9V1.9H7.25L7.25 14.9H8.75Z"
        }))));
      }

      if (!isPenult) {
        buttons.push( /*#__PURE__*/React.createElement("div", {
          key: 'btn_' + id + '_' + index + 'down',
          className: "multiple_block_icon",
          onClick: () => this.dragField(id)
        }, /*#__PURE__*/React.createElement("svg", {
          width: "16",
          height: "16",
          viewBox: "0 0 16 16",
          ...
          d: "M7.46967 14.6303C7.76256 14.9232 8.23744 14.9232 8.53033 14.6303L13.3033 9.85736C13.5962 9.56447 13.5962 9.08959 13.3033 8.7967C13.0104 8.5038 12.5355 8.5038 12.2426 8.7967L8 13.0393L3.75736 8.7967C3.46447 8.5038 2.98959 8.5038 2.6967 8.7967C2.40381 9.08959 2.40381 9.56446 2.6967 9.85736L7.46967 14.6303ZM7.25 1.1L7.25 14.1L8.75 14.1L8.75 1.1L7.25 1.1Z"
        }))));
      }
    }

    return /*#__PURE__*/React.createElement("div", {
      className: 'constructor-actions ' + (isEnd ? 'end' : 'mb-2')
    }, /*#__PURE__*/React.createElement(OverlayTrigger, {
      trigger: "click",
      key: "right",
      placement: "right",
      rootClose: true,
      overlay: /*#__PURE__*/React.createElement(Popover, null, /*#__PURE__*/React.createElement(Popover.Header, {
        as: "h3"
      }, "\u0412\u044B\u0431\u0435\u0440\u0438\u0442\u0435 \u043F\u043E\u043B\u0435", this.state.screen ? /*#__PURE__*/React.createElement("div", {
        className: "constructor-screen"
      }, /*#__PURE__*/React.createElement("img", {
        src: this.state.screen
      })) : ''), /*#__PURE__*/React.createElement(Popover.Body, null, this.state.fieldsToCreate.map((field, index) => {
        let screen = this.props.screen && this.props.screen[field.type] ? this.props.screen[field.type] : null,
            src = field.src ? field.src : screen ? screen : '';
        return /*#__PURE__*/React.createElement("div", {
          key: 'field_' + id + '_' + index,
  ...
  getField(field) {
    ...
    if (field.type == 'string') {
      ...
      result = /*#__PURE__*/React.createElement(TextEditor, {
        name: field.name,
        value: field.value
      });
    } else if (field.type == 'image') {
      result = /*#__PURE__*/React.createElement(File, {
        name: field.name,
        value: field.value
      });
      ...
      result = /*#__PURE__*/React.createElement(Poll, {
        name: field.name,
        value: field.value
      });
    } else {
      result = /*#__PURE__*/React.createElement(CustomField, {
        field: field,
  ...
  getHiddenFields() {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("input", {
      type: "hidden",
      name: this.props.name + '_sort',
      value: result.join(',')
    }), this.state.fields.length == 0 ? /*#__PURE__*/React.createElement("input", {
      type: "hidden",
  ...
  render() {
    return /*#__PURE__*/React.createElement("fieldset", null, this.state.fields.map((field, index) => {
      return /*#__PURE__*/React.createElement("div", {
        key: field.id,
        className: "form-group mb-3"
      }, this.getActions(field.id, index), this.getField(field));
    }), this.getActions(null), this.getHiddenFields());
  }
