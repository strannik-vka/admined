...
class Actions extends React.Component {
  ...
  actions() {
    if (typeof this.props.page.actions !== 'undefined') {
      let result = this.props.page.actions.map((action, i) => /*#__PURE__*/React.createElement("a", {
  ...
  render() {
    ...
    }, this.props.saveStatus)), /*#__PURE__*/React.createElement("div", null, this.actions(), this.props.page.config('deleteAction', true) ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", {
      className: "selected"
